            ...
            <form action="{{route('products.update',$product->id)}}" method="POST" enctype="multipart/form-data" id="productForm">
                ...
                <div class="mb-4">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="is_available" name="is_available" value="1" {{ $product->is_available ? 'checked' : '' }}>
                ...
                <div class="mb-4">
                    ...
                    <div class="radio-group">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="category" id="electronics" value="Electronics" {{ $product->category == 'Electronics' ? 'checked': '' }}>
                            <label class="form-check-label" for="electronics">
                                <i class="bi bi-phone me-1"></i> Electronics
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="category" id="clothing" value="Clothing" {{ $product->category == 'Clothing' ? 'checked': '' }}>
                            <label class="form-check-label" for="clothing">
                                <i class="bi bi-bag me-1"></i> Clothing
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="category" id="food" value="Food" {{ $product->category == 'Food' ? 'checked': '' }}>
                ...
                <div class="mb-4">
                    ...
                    @if ($product->image)
                        <div class="image-preview-container mb-3">
                            ...
                            <img src="{{ asset('storage/' . $product->image) }}" class="current-image" alt="Current Product Image">
                        </div>
                    @endif
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                    <a href="{{ route('products.index') }}" class="btn btn-outline-secondary cancel-btn">
